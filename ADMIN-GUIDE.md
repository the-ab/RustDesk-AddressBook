...
> **0.6.1 → 0.6.2:** use this local signed update path once. The online parser shipped in 0.6.1 does not recognize the dotted release filename in `latest.txt`; that defect is fixed by 0.6.2. The 0.6.1 signature verifier accepts the signed 0.6.2 package.
